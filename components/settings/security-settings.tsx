      ...
      <Card className="opacity-70">
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Shield className="w-5 h-5" />
            Emergency PIN
            <span className="ml-auto text-[10px] font-bold uppercase tracking-widest text-muted-foreground border border-muted-foreground/30 rounded-full px-2.5 py-0.5">
              Coming Soon
            </span>
          </CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="p-4 bg-muted/40 rounded-lg border border-dashed border-muted-foreground/20">
