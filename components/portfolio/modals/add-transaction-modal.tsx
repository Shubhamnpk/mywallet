                ...
                <div className="grid gap-4 py-6" onKeyDown={(e) => e.key === "Enter" && onAdd()}>
                    ...
                    {tradePreview ? (
                        <div className="mt-2 space-y-3 rounded-xl border border-primary/20 bg-primary/5 p-3">
                            <button
                                type="button"
                                className="flex w-full items-center justify-between gap-2 rounded-xl border border-primary/10 bg-background/50 px-2.5 py-2 text-left transition-colors hover:bg-background/70"
