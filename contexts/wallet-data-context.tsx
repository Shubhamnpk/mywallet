...
type WalletDataContextType = {
  ...
  addFromGoal: (goalId: string, amount: number, description: string, category?: string) => Promise<any>
  addFromDebt: (debtAccountId: string, amount: number, description: string, category?: string) => Promise<any>
  ...
  clearAllData: () => void
  exportData: () => void
  importData: (dataOrJson: string | any, unlockPin?: string) => Promise<boolean>
